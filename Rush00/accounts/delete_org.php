<?php
	...
	if ($_SESSION["loggued_on_user"] and $_SESSION["admin"])
	{
		if ($_POST["submit"])
		{
			...
			{
				header("Location: "."./delete_org.php?msg=".$_POST["cat"]." is not a category");
				return ;
			}
					...
					if ($org["name"] == $_POST["name"])
						{
							...
							header("Location: "."./delete_org.php?msg=".$_POST["name"]." successfully deleted");
							return ;
						}
			header("Location: "."./delete_org.php?msg=".$_POST["name"]." does not exist");
		}
	}
	else
